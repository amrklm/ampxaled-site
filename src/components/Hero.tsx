...
const Hero = () => {
  ...
  return <section className="overflow-hidden relative bg-cover" id="hero" style={{
    ...
    backgroundImage: 'url("/animated-header-alternate-lines-animated.svg")',
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            animationDelay: "0.3s"
             ...
             We don’t replace your creativity — <br className="hidden sm:inline" />we elevate it.
            </h1>
            
            <p style={{
            animationDelay: "0.5s"
          }} className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-950 font-normal text-base sm:text-lg text-left">
            At Ampxaled Studio, we work alongside your team to streamline 3D production, simplify technical barriers, and enhance visual storytelling. From concept to final render, we handle the heavy lifting so you can focus on what matters most: creating bold, original work.</p>
            ...
            }} className="flex items-center justify-center group w-full sm:w-auto text-center px-8 py-3 rounded-xl bg-black text-white ">
                Request a Quote
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            {lottieData ? <div className="relative z-10 animate-fade-in" style={{animationDelay: "0.9s"}}>
